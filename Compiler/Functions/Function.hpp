...
class Function : public Generic<Function, FunctionReification>, public Definition {
public:
    Function() = delete;
    ...
    /// Practically, this means that the function does not have a body and is just linked against the specified name.
    ...
    bool overriding() const { return superFunction_ != nullptr; }

    Function* superFunction() const { return superFunction_; }
    void setSuperFunction(Function *function) { superFunction_ = function; }
