...
//
//  Generated by generate_emoji_names.py from the Unicode 18.0.0 names. Do not edit.
//
...
const EmojiName kEmojiNames[] = {
    ...
    {0x1FAF9, "leftwards thumb sign"},
    {0x1FAFA, "rightwards thumb sign"},
};
